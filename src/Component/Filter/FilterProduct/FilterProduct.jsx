  ...
  return (
    <div>
      <div className="  w-full  ">
        <div className=" container mx-auto px-32 mt-4 bg-red-200">
          <div className="flex justify-between  ">
            <div className="flex gap-44 relative">
              <button
                className="bg-[#00B207] flex justify-center items-center gap-2  px-6 py-3 rounded-3xl text-white text-sm "
                ...
                <span className=" text-slate-500 text-xs mx-2 border rounded-md">
                  <label htmlFor="filter-select">
                    ...
                    >
                      ...
                      <option value="indian">Sale</option>
                    </select>
                  </label>
                </span>
              </div>

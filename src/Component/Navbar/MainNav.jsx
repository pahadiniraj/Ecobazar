...
function MainNav() {
  return (
    <nav className=" mx-auto flex justify-between py-4 px-2 w-full text-sm">
      <div className=" container w-full flex justify-between mx-auto px-28 ">
        <div className="flex gap-2">
          ...
          <span className="text-3xl font-medium ">Ecobazar</span>
        </div>
        <div>
          <span>
            <span className=" p-2 border-solid border-x border-y rounded-s border-slate-300 w-60">
